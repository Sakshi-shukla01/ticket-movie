...
const Navbar = () => {
  ...
  // ✅ FIX #1: also get isAdmin from context
 ...
 // ✅ Navbar.jsx (only baseLinks part)


const baseLinks = [
  { path: "/", label: "Home" },
  { path: "/movies", label: "Movies" },
  { path: "/", label: "Theaters" }, // ✅ redirect home
];

// ✅ show admin link only if admin
if (isAdmin) {
  baseLinks.push({ path: "/admin", label: "Admin" }); // ✅ stays /admin
}

// ✅ favorites link (your same logic)
