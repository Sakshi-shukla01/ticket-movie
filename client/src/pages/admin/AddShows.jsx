...
const AddShows = () => {
  ...
  const inputRef = useRef(null); // ✅ For focusing input programmatically
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <button className="ml-4 bg-red-500 text-white px-8 py-2 mt-6 rounded hover:bg-red-600  transition-all cursor-pointer" >
      Add Show</button>
    </>
  ) : (
    <Loading />
